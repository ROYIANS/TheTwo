...
export const agentReplies = {
  ...
  profile: "我只看这些事实的来源、冲突和空白。哪一句不像你真正做过的，或者还缺关键背景，我们就从那里开始。",
  research: "建议是从 2 条支持信息、1 条冲突和 1 个弱信号拼起来的。不是定论——如果实际工作方式跟材料里说的不一样，这个建议就要重新算。",
  application: "我会把材料里的表达逐条对回职业事实和这份机会。风险、未知和不该替你说的话，也会留在桌面上。",
  interview: "先看这次面试需要验证什么。准备和复盘都围绕真实问题，不把一次结果变成对你的评分。",
};
